const buyData = async (phone, plan) => {
    try {
        const res = await fetcher.post(`/api/transaction/buy-data`, {phone, plan});
...
document.querySelector("#data-summary-form").addEventListener("submit", handleDataSummarySummit)