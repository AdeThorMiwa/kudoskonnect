const subscribe = async (cable, plan, number) => {
    try {
        const res = await fetcher.post(`/api/transaction/pay-cable-tv`, {cable, plan, number});
...
document.querySelector("#cable-summary-form").addEventListener("submit", handleCableSummarySummit)