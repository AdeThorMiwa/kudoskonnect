const buyAirtime = async (phone, amount) => {
    try {
        const res = await fetcher.post(`/api/transaction/buy-airtime`, {phone, amount});
...
document.querySelector("#airtime-summary-form").addEventListener("submit", handleAirtimeSummarySummit)